...
RUN DEBIAN_FRONTEND=noninteractive apt-get install -y unzip wget git default-jdk chromium=90.* xorg vnc4server autocutsel lxde-core novnc python-websockify 
